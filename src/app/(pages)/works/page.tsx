    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-24 px-4 border-b border-gray-100">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-800 text-lg leading-relaxed font-light mb-8">
            At Shop.co, we&rsquo;ve streamlined every step of your shopping journey to provide a smooth, enjoyable experience. 
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center px-4">
          ...
          <p className="text-gray-800 text-lg leading-relaxed font-light mb-8">
            Once you&rsquo;ve placed your order, we take care of the rest. Our efficient fulfillment process ensures your order reaches you promptly.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
            <div className="work-card">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
            <div className="work-card">
              ...
              <p className="text-gray-600">If you&rsquo;re not satisfied with your purchase, return it easily within 30 days for a full refund.</p>
            </div>
            <div className="work-card">
