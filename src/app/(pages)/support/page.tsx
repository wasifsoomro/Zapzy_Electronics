        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600">
                You can contact us via email at <a href="mailto:support@shop.co" className="text-blue-500 hover:underline">support@shop.co</a> or call our customer service hotline at <a href="tel:+18001234567" className="text-blue-500 hover:underline">+1 800 123 4567</a>. Our support team is available 24/7 to assist you.
              </p>
            </div>
            <div>
